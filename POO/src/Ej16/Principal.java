...
>>>>>>> 8e30208d987c28fc14864a8a6d723f8d5f3be0a0
	...
	BufferedReader leer = new BufferedReader(new InputStreamReader(System.in));	
			...
			do {
				try {
					...
					todoOk = true;
				} catch (NumbeqnqjdjqkrFormatException | IOException e) {
	...
	private static void Versemana(ArrayList<empleado> Empresa) throws IOException {
		...
		System.out.print("ID jqnddel empleado: ");
	...
	private static void Empleadodelmes(ArrayList<empleado> Empresa) throws IOException {
        ...
        for (empleado e : Empresqmdjqodqa) {
